// 2D human Image with openGL
//using Quads to draw the shapes and the place in position
...
glPointSize(1.0);
glBegin(GL_QUADS);
glVertex2i(106.369,35.656);
glVertex2i(64.198,35.656);
glVertex2i(64.198,60.019);
glVertex2i(106.369,60.020);
glEnd();
...
glPointSize(1.0);
glBegin(GL_QUADS);
glVertex2i( 167.095,35.337 );
glVertex2i(124.924,35.337);
...
glVertex2i(98.407,253.766);
glVertex2i(98.407,264.89);
glVertex2i(135.05,264.89);
glEnd();


glColor3ub (251,225,100);
glPointSize(1.0);
glBegin(GL_QUADS);
...
void myInit (void)
{
glClearColor(0.5f,0.4f,0.9f,0.3f);
glMatrixMode(GL_PROJECTION);
glLoadIdentity();
gluOrtho2D(-150.0,320.0,-90.0,350.0);
}
